...
INSERT INTO `ncconfig` VALUES ('13', 'SITE_TITLE', 'site', '1448285156', 'YKTB商城', '', '0');
INSERT INTO `ncconfig` VALUES ('14', 'SITE_NAME', 'site', '1448285156', 'YKTB', '', '0');
INSERT INTO `ncconfig` VALUES ('15', 'SITE_DESCRIPTION', 'site', '1448285156', '《YKTB商城》协议《YKTB商城》协议《YKTB商城》协议《YKTB商城》协议《YKTB商城》协议《YKTB商城》协议《YKTB商城》协议', '', '0');
INSERT INTO `ncconfig` VALUES ('16', 'SITE_KEYWORDS', 'site', '1448285156', 'YKTB商城', '', '0');
...
) ENGINE=MyISAM AUTO_INCREMENT=87 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='系统配置表';
...
INSERT INTO `ysk_config` VALUES ('86', '单笔升级订单金额', 'money', '20', '0', '', '', '', '0', '0', '0', '1');
...
-- ----------------------------
-- Table structure for `ysk_lengque`
-- ----------------------------
DROP TABLE IF EXISTS `ysk_lengque`;
CREATE TABLE `ysk_lengque` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL COMMENT '用户ID',
  `time` varchar(255) NOT NULL COMMENT '达标时间',
...
CREATE TABLE `ysk_user` (
  ...
  `money` int(255) DEFAULT '0' COMMENT '用户的正常收益',
...
) ENGINE=MyISAM AUTO_INCREMENT=235 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户行为';
